...
3. Amap key remains a placeholder in the public YAML. Do not commit real API keys to the public repository; fill the key after importing to Dify or use a local untracked import copy.
